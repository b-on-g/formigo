...
declare namespace $ {
    const $mol_theme: Record<"image" | "line" | "text" | "current" | "field" | "hue" | "back" | "focus" | "hover" | "card" | "special" | "control" | "shade" | "spirit" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $.$$ {
    class $bog_formigo_filler_step extends $.$bog_formigo_filler_step {
        ...
        suggestion_text(): string;
        apply_click(): void;
        input_widget(): $.$mol_string | $.$mol_textarea | $.$mol_number | $.$mol_switch | $.$mol_date | $.$mol_attach;
        content(): any[];
    }
}
