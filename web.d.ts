...
declare namespace $ {
    const $mol_theme: Record<"image" | "line" | "text" | "field" | "current" | "hover" | "hue" | "back" | "focus" | "card" | "special" | "control" | "shade" | "spirit" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
    const $bog_formigo_workspace_base: Omit<typeof $giper_baza_entity, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_entity, {
            readonly Hue: (auto?: any) => $giper_baza_atom_real | null;
            readonly Tier: (auto?: any) => $giper_baza_atom_text | null;
            readonly Templates: (auto?: any) => {
                remote_list(next?: readonly $bog_formigo_template[] | undefined): readonly $bog_formigo_template[];
                remote_add(item: $bog_formigo_template): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_template;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
        ...
        schema: {
            ...
            readonly Hue: typeof $giper_baza_atom_real;
            readonly Tier: typeof $giper_baza_atom_text;
            readonly Templates: {
                new (): {
                    remote_list(next?: readonly $bog_formigo_template[] | undefined): readonly $bog_formigo_template[];
                    remote_add(item: $bog_formigo_template): void;
    ...
    export class $bog_formigo_workspace extends $bog_formigo_workspace_base {
    }
    const $bog_formigo_template_base: Omit<typeof $giper_baza_entity, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_entity, {
            readonly Description: (auto?: any) => $giper_baza_atom_text | null;
            readonly Fields: (auto?: any) => {
                remote_list(next?: readonly $bog_formigo_field_def[] | undefined): readonly $bog_formigo_field_def[];
                remote_add(item: $bog_formigo_field_def): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_field_def;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
            ...
            readonly Submissions: (auto?: any) => {
                remote_list(next?: readonly $bog_formigo_submission[] | undefined): readonly $bog_formigo_submission[];
                remote_add(item: $bog_formigo_submission): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_submission;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
            ...
            readonly Created: (auto?: any) => $giper_baza_atom_time | null;
        }>;
        path: string;
    } & {
        schema: {
            ...
            readonly Created: typeof $giper_baza_atom_time;
        };
    };
    export class $bog_formigo_template extends $bog_formigo_template_base {
    }
    const $bog_formigo_field_def_base: Omit<typeof $giper_baza_dict, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_dict, {
            readonly Label: (auto?: any) => $giper_baza_atom_text | null;
            readonly Type: (auto?: any) => $giper_baza_atom_text | null;
            readonly Hint: (auto?: any) => $giper_baza_atom_text | null;
            readonly Required: (auto?: any) => $giper_baza_atom_bool | null;
            readonly Options: (auto?: any) => $giper_baza_list_str | null;
            readonly Ai_key: (auto?: any) => $giper_baza_atom_text | null;
            readonly Section: (auto?: any) => $giper_baza_atom_text | null;
        ...
        schema: {
            ...
            readonly Label: typeof $giper_baza_atom_text;
            readonly Type: typeof $giper_baza_atom_text;
            readonly Hint: typeof $giper_baza_atom_text;
            readonly Required: typeof $giper_baza_atom_bool;
            readonly Options: typeof $giper_baza_list_str;
            readonly Ai_key: typeof $giper_baza_atom_text;
            readonly Section: typeof $giper_baza_atom_text;
            readonly Order: typeof $giper_baza_atom_real;
        };
    };
    export class $bog_formigo_field_def extends $bog_formigo_field_def_base {
    }
    const $bog_formigo_submission_base: Omit<typeof $giper_baza_entity, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_entity, {
            readonly Template: (auto?: any) => {
                Value: Value;
                remote(next?: $bog_formigo_template | null | undefined): $bog_formigo_template | null;
                remote_of(peer: $giper_baza_link | null, next?: $bog_formigo_template | null | undefined): $bog_formigo_template | null;
                ensure(config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_template | null;
                ensure_of(peer: $giper_baza_link | null, config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_template | null;
                ensure_here(peer: $giper_baza_link | null): void;
                ensure_area(peer: $giper_baza_link | null, land: $giper_baza_land): void;
                ensure_lord(peer: $giper_baza_link | null, preset: $giper_baza_rank_preset): void;
                remote_ensure(preset?: $giper_baza_rank_preset): $bog_formigo_template | null;
                local_ensure(): $bog_formigo_template | null;
                val(next?: $giper_baza_link | null | undefined): $giper_baza_link | null;
                val_of(peer: $giper_baza_link | null, next?: $giper_baza_link | null | undefined): $giper_baza_link | null;
                pick_unit(peer: $giper_baza_link | null): $giper_baza_unit_sand | undefined;
                vary(next?: $giper_baza_vary_type): $giper_baza_vary_type;
            ...
            readonly Created: (auto?: any) => $giper_baza_atom_time | null;
            readonly Respondent: (auto?: any) => $giper_baza_atom_text | null;
            readonly Documents: (auto?: any) => {
                remote_list(next?: readonly $bog_formigo_document[] | undefined): readonly $bog_formigo_document[];
                remote_add(item: $bog_formigo_document): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_document;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
        ...
        schema: {
            ...
            readonly Template: {
                new (): {
                    Value: () => typeof $bog_formigo_template;
                    remote(next?: $bog_formigo_template | null | undefined): $bog_formigo_template | null;
                    remote_of(peer: $giper_baza_link | null, next?: $bog_formigo_template | null | undefined): $bog_formigo_template | null;
                    ensure(config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_template | null;
                    ensure_of(peer: $giper_baza_link | null, config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_formigo_template | null;
            ...
            readonly Created: typeof $giper_baza_atom_time;
            readonly Respondent: typeof $giper_baza_atom_text;
            readonly Documents: {
                new (): {
                    remote_list(next?: readonly $bog_formigo_document[] | undefined): readonly $bog_formigo_document[];
                    remote_add(item: $bog_formigo_document): void;
    ...
    export class $bog_formigo_submission extends $bog_formigo_submission_base {
        field_value(key: string, next?: string): string;
    }
    const $bog_formigo_document_base: Omit<typeof $giper_baza_dict, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_dict, {
            readonly Title: (auto?: any) => $giper_baza_atom_text | null;
            readonly Data_uri: (auto?: any) => $giper_baza_atom_text | null;
            readonly Extracted: (auto?: any) => $giper_baza_atom_text | null;
            readonly Doc_type: (auto?: any) => $giper_baza_atom_text | null;
        }>;
        path: string;
    } & {
        schema: {
            ...
            readonly Title: typeof $giper_baza_atom_text;
            readonly Data_uri: typeof $giper_baza_atom_text;
            readonly Extracted: typeof $giper_baza_atom_text;
            readonly Doc_type: typeof $giper_baza_atom_text;
        };
    };
...
declare namespace $ {
	...
	type $mol_link__arg_bog_formigo_dashboard_1 = $mol_type_enforce<
		({ 
			'settings': string,
			'template': any,
			'fill': any,
		...
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub_bog_formigo_dashboard_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_list__rows_bog_formigo_dashboard_3 = $mol_type_enforce<
		ReturnType< $bog_formigo_dashboard['template_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_status__sub_bog_formigo_dashboard_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_status['sub'] >
	>
	type $mol_button_major__title_bog_formigo_dashboard_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_formigo_dashboard_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_dashboard['add_template'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $bog_formigo_dashboard_card__template_title_bog_formigo_dashboard_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_dashboard['template_title'] >
		,
		ReturnType< $bog_formigo_dashboard_card['template_title'] >
	>
	type $bog_formigo_dashboard_card__template_link_bog_formigo_dashboard_8 = $mol_type_enforce<
		ReturnType< $bog_formigo_dashboard['template_link'] >
		,
		ReturnType< $bog_formigo_dashboard_card['template_link'] >
	>
	type $bog_formigo_dashboard_card__submissions_count_bog_formigo_dashboard_9 = $mol_type_enforce<
		ReturnType< $bog_formigo_dashboard['template_submissions_count'] >
		,
		ReturnType< $bog_formigo_dashboard_card['submissions_count'] >
	>
	type $bog_formigo_dashboard_card__published_bog_formigo_dashboard_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_dashboard['template_published'] >
		,
		ReturnType< $bog_formigo_dashboard_card['published'] >
	>
	export class $bog_formigo_dashboard extends $mol_page {
		...
		Templates( ): $mol_list
		Empty( ): $mol_status
		add_template( next?: any ): any
		Add( ): $mol_button_major
		template_title( id: any): string
		template_link( id: any): string
		template_submissions_count( id: any): number
		template_published( id: any): boolean
		title( ): string
		workspace( ): $bog_formigo_workspace
		template_select( id: any): any
		tools( ): readonly(any)[]
		body( ): readonly(any)[]
		foot( ): readonly(any)[]
		Template_card( id: any): $bog_formigo_dashboard_card
	}
	
	type $mol_view__sub_bog_formigo_dashboard_card_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_dashboard_card_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_formigo_dashboard_card extends $mol_link {
		...
		arg( ): ({ 
			'template': ReturnType< $bog_formigo_dashboard_card['template_link'] >,
			'fill': any,
			'submissions': any,
			'submission': any,
			'settings': any,
...
declare namespace $.$$ {
    class $bog_formigo_dashboard extends $.$bog_formigo_dashboard {
        templates(): readonly $bog_formigo_template[];
        template_rows(): $.$mol_status[] | $.$bog_formigo_dashboard_card[];
        template_title(index: number): string;
        template_description(index: number): string;
        template_submissions_count(index: number): number;
        template_published(index: number): boolean;
        template_link(index: number): string;
        add_template(): void;
    }
...
declare namespace $ {
	...
	export class $mol_icon_drag extends $mol_icon {
		path( ): string
	}
...
declare namespace $ {
	...
	export class $mol_icon_drag_horizontal extends $mol_icon {
		path( ): string
	}
...
declare namespace $ {
	...
	type $mol_view__sub_bog_formigo_builder_field_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_builder_field_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_builder_field_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__click_bog_formigo_builder_field_4 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_field['select_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_formigo_builder_field_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__click_bog_formigo_builder_field_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_field['remove_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_formigo_builder_field_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	export class $bog_formigo_builder_field extends $mol_view {
		Drag_icon( ): $mol_icon_drag_horizontal_variant
		required_mark( ): string
		Required_mark( ): $mol_view
		Label( ): $mol_view
		Type_badge( ): $mol_view
		select_click( next?: any ): any
		...
		field_select( id: any): any
		field_remove( id: any): any
		sub( ): readonly(any)[]
	}
...
declare namespace $ {
	...
	type $mol_status__sub_bog_formigo_builder_props_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_status['sub'] >
	>
	type $mol_list__rows_bog_formigo_builder_props_2 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['form_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_string__value_bog_formigo_builder_props_3 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['label'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint_bog_formigo_builder_props_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_select__value_bog_formigo_builder_props_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['type'] >
		,
		ReturnType< $mol_select['value'] >
	>
	type $mol_select__dictionary_bog_formigo_builder_props_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['type_options'] >
		,
		ReturnType< $mol_select['dictionary'] >
	>
	type $mol_string__value_bog_formigo_builder_props_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['hint'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint_bog_formigo_builder_props_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_check_box__checked_bog_formigo_builder_props_9 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['required'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_select__value_bog_formigo_builder_props_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['ai_key'] >
		,
		ReturnType< $mol_select['value'] >
	>
	type $mol_select__dictionary_bog_formigo_builder_props_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['ai_key_options'] >
		,
		ReturnType< $mol_select['dictionary'] >
	>
	type $mol_textarea__value_bog_formigo_builder_props_12 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['options_text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_textarea__hint_bog_formigo_builder_props_13 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_string__value_bog_formigo_builder_props_14 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['section'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint_bog_formigo_builder_props_15 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_16 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_17 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Label_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_18 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_19 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Type_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_20 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_21 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Hint_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_22 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_23 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Required_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_24 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_25 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Ai_key_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_26 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_27 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Options_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_form_field__name_bog_formigo_builder_props_28 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_props_29 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder_props['Section_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	export class $bog_formigo_builder_props extends $mol_page {
		No_field( ): $mol_status
		form_rows( ): readonly(any)[]
		Form( ): $mol_list
		label( next?: string ): string
		Label_input( ): $mol_string
		type( next?: string ): string
		type_options( ): ({ 
			'str': string,
			'text': string,
		...
		Type_input( ): $mol_select
		hint( next?: string ): string
		Hint_input( ): $mol_string
		required( next?: boolean ): boolean
		Required_input( ): $mol_check_box
		ai_key( next?: string ): string
		ai_key_options( ): ({ 
			'none': string,
			'full_name': string,
			'first_name': string,
		...
		Ai_key_input( ): $mol_select
		options_text( next?: string ): string
		Options_input( ): $mol_textarea
		section( next?: string ): string
		Section_input( ): $mol_string
		field( ): any
		title( ): string
		body( ): readonly(any)[]
...
//# sourceMappingURL=props.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_formigo_builder_props extends $.$bog_formigo_builder_props {
        form_rows(): any[];
        get_field(): $bog_formigo_field_def | null;
        label(next?: string): string;
        type(next?: string): string;
        hint(next?: string): string;
        required(next?: boolean): boolean;
...
declare namespace $ {
	...
	type $mol_link__arg_bog_formigo_builder_1 = $mol_type_enforce<
		({ 
			'fill': ReturnType< $bog_formigo_builder['template_link'] >,
			'template': any,
			'submissions': any,
			'submission': any,
			'settings': any,
		...
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub_bog_formigo_builder_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_link__arg_bog_formigo_builder_3 = $mol_type_enforce<
		({ 
			'submissions': ReturnType< $bog_formigo_builder['template_link'] >,
			'template': any,
			'fill': any,
			'submission': any,
			'settings': any,
		...
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub_bog_formigo_builder_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_check_icon__checked_bog_formigo_builder_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['published'] >
		,
		ReturnType< $mol_check_icon['checked'] >
	>
	type $mol_check_icon__Icon_bog_formigo_builder_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['Publish_icon'] >
		,
		ReturnType< $mol_check_icon['Icon'] >
	>
	type $mol_string__value_bog_formigo_builder_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['form_title_edit'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint_bog_formigo_builder_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_form_field__name_bog_formigo_builder_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['Title_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_textarea__value_bog_formigo_builder_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['description'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_textarea__hint_bog_formigo_builder_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_form_field__name_bog_formigo_builder_13 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_builder_14 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['Description_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_list__rows_bog_formigo_builder_15 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_labeler__title_bog_formigo_builder_16 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_builder_17 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['Fields'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_button_major__title_bog_formigo_builder_18 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_formigo_builder_19 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['add_field'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $bog_formigo_builder_field__field_index_bog_formigo_builder_20 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_index'] >
		,
		ReturnType< $bog_formigo_builder_field['field_index'] >
	>
	type $bog_formigo_builder_field__field_label_bog_formigo_builder_21 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_label'] >
		,
		ReturnType< $bog_formigo_builder_field['field_label'] >
	>
	type $bog_formigo_builder_field__field_type_bog_formigo_builder_22 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_type'] >
		,
		ReturnType< $bog_formigo_builder_field['field_type'] >
	>
	type $bog_formigo_builder_field__field_required_bog_formigo_builder_23 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_required'] >
		,
		ReturnType< $bog_formigo_builder_field['field_required'] >
	>
	type $bog_formigo_builder_field__field_select_bog_formigo_builder_24 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_select'] >
		,
		ReturnType< $bog_formigo_builder_field['field_select'] >
	>
	type $bog_formigo_builder_field__field_remove_bog_formigo_builder_25 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['field_remove'] >
		,
		ReturnType< $bog_formigo_builder_field['field_remove'] >
	>
	type $bog_formigo_builder_props__field_bog_formigo_builder_26 = $mol_type_enforce<
		ReturnType< $bog_formigo_builder['selected_field'] >
		,
		ReturnType< $bog_formigo_builder_props['field'] >
	>
	export class $bog_formigo_builder extends $mol_page {
		form_title( ): string
		...
		Publish_icon( ): $mol_icon_earth
		Publish( ): $mol_check_icon
		form_title_edit( next?: string ): string
		Title_input( ): $mol_string
		Title_field( ): $mol_form_field
		description( next?: string ): string
		Description_input( ): $mol_textarea
		Description_field( ): $mol_form_field
		field_rows( ): readonly(any)[]
		Fields( ): $mol_list
		Fields_label( ): $mol_labeler
		add_field( next?: any ): any
		Add_field( ): $mol_button_major
		field_index( id: any): number
		field_label( id: any): string
		field_type( id: any): string
		field_required( id: any): boolean
		field_select( id: any): any
		field_remove( id: any): any
		selected_field( ): any
		template( ): $bog_formigo_template
		title( ): ReturnType< $bog_formigo_builder['form_title'] >
		tools( ): readonly(any)[]
		body( ): readonly(any)[]
		selected( next?: any ): any
		Field_row( id: any): $bog_formigo_builder_field
...
declare namespace $.$$ {
    class $bog_formigo_builder extends $.$bog_formigo_builder {
        fields(): readonly $bog_formigo_field_def[];
        form_title(): string;
        form_title_edit(next?: string): string;
        description(next?: string): string;
        published(next?: boolean): boolean;
        template_link(): string;
        field_rows(): $.$bog_formigo_builder_field[];
        field_label(index: number): string;
        field_type(index: number): string;
        field_required(index: number): boolean;
        field_select(index: number): void;
        field_remove(index: number): void;
        add_field(): void;
        selected_field(): $bog_formigo_field_def | null;
    }
}
...
declare namespace $ {
	...
	type $mol_view__sub_bog_formigo_filler_step_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_filler_step_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_filler_step_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__title_bog_formigo_filler_step_4 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['suggestion_text'] >
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_formigo_filler_step_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['apply_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_string__value_bog_formigo_filler_step_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['value'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint_bog_formigo_filler_step_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['hint'] >
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_textarea__value_bog_formigo_filler_step_8 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['value'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_textarea__hint_bog_formigo_filler_step_9 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['hint'] >
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_number__value_bog_formigo_filler_step_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['number_value'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_switch__value_bog_formigo_filler_step_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['value'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__dictionary_bog_formigo_filler_step_12 = $mol_type_enforce<
		({ 
			'yes': string,
			'no': string,
		}) 
		,
		ReturnType< $mol_switch['dictionary'] >
	>
	type $mol_switch__value_bog_formigo_filler_step_13 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['value'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__dictionary_bog_formigo_filler_step_14 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['enum_options'] >
		,
		ReturnType< $mol_switch['dictionary'] >
	>
	type $mol_date__value_bog_formigo_filler_step_15 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['value'] >
		,
		ReturnType< $mol_date['value'] >
	>
	type $mol_attach__items_bog_formigo_filler_step_16 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler_step['file_items'] >
		,
		ReturnType< $mol_attach['items'] >
	>
	export class $bog_formigo_filler_step extends $mol_list {
		content( ): readonly(any)[]
		label( ): string
		hint( ): string
		required_text( ): string
		suggestion_text( ): string
		apply_click( next?: any ): any
		number_value( next?: number ): number
		enum_options( ): Record<string, any>
		file_items( next?: readonly(string)[] ): readonly(string)[]
		field_def( ): any
		value( next?: string ): string
		ai_suggestion( ): string
		apply_suggestion( id: any): any
		rows( ): ReturnType< $bog_formigo_filler_step['content'] >
		Label( ): $mol_view
		Hint( ): $mol_view
...
declare namespace $.$$ {
    class $bog_formigo_filler_step extends $.$bog_formigo_filler_step {
        ...
        number_value(next?: number): number;
        file_items(next?: string[]): string[];
        suggestion_text(): string;
        apply_click(): void;
        input_widget(): $.$mol_string | $.$mol_number | $.$mol_textarea | $.$mol_date | $.$mol_switch | $.$mol_attach;
        content(): any[];
    }
}
...
declare namespace $ {
	...
	type $mol_view__sub_bog_formigo_filler_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows_bog_formigo_filler_2 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['step_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_minor__title_bog_formigo_filler_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_formigo_filler_4 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['back'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_view__sub_bog_formigo_filler_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_major__title_bog_formigo_filler_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['next_title'] >
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_formigo_filler_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['next'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_view__sub_bog_formigo_filler_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_filler_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_formigo_filler_step__field_def_bog_formigo_filler_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['step_field'] >
		,
		ReturnType< $bog_formigo_filler_step['field_def'] >
	>
	type $bog_formigo_filler_step__value_bog_formigo_filler_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['step_value'] >
		,
		ReturnType< $bog_formigo_filler_step['value'] >
	>
	type $bog_formigo_filler_step__ai_suggestion_bog_formigo_filler_12 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['step_ai_suggestion'] >
		,
		ReturnType< $bog_formigo_filler_step['ai_suggestion'] >
	>
	type $bog_formigo_filler_step__apply_suggestion_bog_formigo_filler_13 = $mol_type_enforce<
		ReturnType< $bog_formigo_filler['apply_suggestion'] >
		,
		ReturnType< $bog_formigo_filler_step['apply_suggestion'] >
	>
	type $mol_view__sub_bog_formigo_filler_14 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_formigo_filler extends $mol_page {
		form_title( ): string
		...
		step_counter_text( ): string
		Step_counter( ): $mol_view
		next_title( ): string
		next( next?: any ): any
		Next( ): $mol_button_major
		Nav( ): $mol_view
		step_field( id: any): any
		step_value( id: any, next?: string ): string
		step_ai_suggestion( id: any): string
		apply_suggestion( id: any): any
		Review_title( ): $mol_view
		template( ): $bog_formigo_template
		submission( ): $bog_formigo_submission
		ai_suggestions( ): Record<string, any>
		title( ): ReturnType< $bog_formigo_filler['form_title'] >
		tools( ): readonly(any)[]
		body( ): readonly(any)[]
		foot( ): readonly(any)[]
		current_step( next?: number ): number
		Step( id: any): $bog_formigo_filler_step
...
declare namespace $.$$ {
    class $bog_formigo_filler extends $.$bog_formigo_filler {
        ...
        step_counter_text(): string;
        step_rows(): $mol_view[];
        step_field(index: number): $bog_formigo_field_def;
        step_value(index: number, next?: string): string;
        step_ai_suggestion(index: number): string;
        apply_suggestion(index: number): void;
        next_title(): string;
        next(): void;
        back(): void;
        submit_form(): void;
...
declare namespace $ {
	...
	type $mol_link__arg_bog_formigo_submissions_1 = $mol_type_enforce<
		({ 
			'submissions': any,
			'template': ReturnType< $bog_formigo_submissions['template_link'] >,
		}) 
		,
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub_bog_formigo_submissions_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_list__rows_bog_formigo_submissions_3 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions['submission_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_status__sub_bog_formigo_submissions_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_status['sub'] >
	>
	type $mol_view__sub_bog_formigo_submissions_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_submissions_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_submissions_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_link__arg_bog_formigo_submissions_8 = $mol_type_enforce<
		({ 
			'submission': ReturnType< $bog_formigo_submissions['submission_link'] >,
			'submissions': any,
			'template': any,
			'fill': any,
			'settings': any,
		...
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub_bog_formigo_submissions_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	export class $bog_formigo_submissions extends $mol_page {
		page_title( ): string
		template_link( ): string
		Back_icon( ): $mol_icon_arrow_left
		Back_link( ): $mol_link
		submission_rows( ): readonly(any)[]
		List( ): $mol_list
		Empty( ): $mol_status
		submission_link( id: any): string
		submission_respondent( id: any): string
		Card_respondent( id: any): $mol_view
		submission_status( id: any): string
		Card_status( id: any): $mol_view
		submission_date( id: any): string
		Card_date( id: any): $mol_view
		template( ): $bog_formigo_template
		title( ): ReturnType< $bog_formigo_submissions['page_title'] >
		tools( ): readonly(any)[]
		body( ): readonly(any)[]
		Submission_card( id: any): $mol_link
	}
	
}

//# sourceMappingURL=submissions.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_formigo_submissions extends $.$bog_formigo_submissions {
        submissions(): readonly $bog_formigo_submission[];
        template_link(): string;
        page_title(): string;
        submission_rows(): $.$mol_status[] | $.$mol_link[];
        submission_link(index: number): string;
        submission_respondent(index: number): string;
        submission_status(index: number): string;
        submission_date(index: number): string;
    }
}
...
declare namespace $ {
    function $bog_formigo_export_doc(title: string, workspace_name: string, fields: {
        label: string;
        value: string;
    }[]): Blob;
}
...
declare namespace $ {
	...
	type $mol_button_download__blob_bog_formigo_submissions_detail_1 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['export_blob'] >
		,
		ReturnType< $mol_button_download['blob'] >
	>
	type $mol_button_download__file_name_bog_formigo_submissions_detail_2 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['export_name'] >
		,
		ReturnType< $mol_button_download['file_name'] >
	>
	type $mol_button_download__sub_bog_formigo_submissions_detail_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_download['sub'] >
	>
	type $mol_list__rows_bog_formigo_submissions_detail_4 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['info_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__rows_bog_formigo_submissions_detail_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['field_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_view__sub_bog_formigo_submissions_detail_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_submissions_detail_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_submissions_detail_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_submissions_detail_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_labeler__title_bog_formigo_submissions_detail_10 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_submissions_detail_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['Respondent_value'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_labeler__title_bog_formigo_submissions_detail_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_submissions_detail_13 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['Status_value'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_labeler__title_bog_formigo_submissions_detail_14 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_submissions_detail_15 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['Date_value'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_labeler__title_bog_formigo_submissions_detail_16 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['field_label'] >
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_submissions_detail_17 = $mol_type_enforce<
		ReturnType< $bog_formigo_submissions_detail['Field_value'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	export class $bog_formigo_submissions_detail extends $mol_page {
		export_blob( ): any
		export_name( ): string
		Export_icon( ): $mol_icon_download
		Export( ): $mol_button_download
		info_rows( ): readonly(any)[]
		Info( ): $mol_list
		field_rows( ): readonly(any)[]
		Fields( ): $mol_list
		respondent( ): string
		Respondent_value( ): $mol_view
		status( ): string
		Status_value( ): $mol_view
		date_text( ): string
		Date_value( ): $mol_view
		field_label( id: any): string
		field_value( id: any): string
		Field_value( id: any): $mol_view
		submission( ): $bog_formigo_submission
		workspace( ): $bog_formigo_workspace
		title( ): string
		tools( ): readonly(any)[]
...
declare namespace $.$$ {
    class $bog_formigo_submissions_detail extends $.$bog_formigo_submissions_detail {
        template(): $bog_formigo_template | null;
        fields(): readonly $bog_formigo_field_def[];
        respondent(): string;
        status(): string;
        date_text(): string;
        info_rows(): $mol_labeler[];
        field_rows(): $mol_labeler[];
        field_label(index: number): string;
        field_value(index: number): string;
        export_name(): string;
        export_blob(): Blob;
    }
}
...
declare namespace $ {
	...
	type $mol_string__value_bog_formigo_settings_1 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['company_name'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint_bog_formigo_settings_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_form_field__name_bog_formigo_settings_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_settings_4 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['Name_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_number__value_bog_formigo_settings_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['hue'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_number__precision_bog_formigo_settings_6 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['precision'] >
	>
	type $mol_number__value_min_bog_formigo_settings_7 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['value_min'] >
	>
	type $mol_number__value_max_bog_formigo_settings_8 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_number['value_max'] >
	>
	type $mol_form_field__name_bog_formigo_settings_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__Content_bog_formigo_settings_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['Hue_input'] >
		,
		ReturnType< $mol_form_field['Content'] >
	>
	type $mol_view__sub_bog_formigo_settings_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows_bog_formigo_settings_12 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_labeler__title_bog_formigo_settings_13 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_settings_14 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['Brand_form'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_view__sub_bog_formigo_settings_15 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_formigo_settings_16 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_labeler__title_bog_formigo_settings_17 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_settings_18 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['Auth_key'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_list__rows_bog_formigo_settings_19 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_labeler__title_bog_formigo_settings_20 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_settings_21 = $mol_type_enforce<
		ReturnType< $bog_formigo_settings['Auth_info'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	export class $bog_formigo_settings extends $mol_page {
		company_name( next?: string ): string
		Name_input( ): $mol_string
		Name_field( ): $mol_form_field
		hue( next?: number ): number
		Hue_input( ): $mol_number
		Hue_field( ): $mol_form_field
		hue_preview_text( ): string
...
declare namespace $ {
	...
	type $mol_view__sub_bog_formigo_ai_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_github_model__params_bog_formigo_ai_2 = $mol_type_enforce<
		({ 
			'temperature': number,
		}) 
		,
	...
	>
	type $mol_github_model__rules_bog_formigo_ai_3 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['rules'] >
		,
		ReturnType< $mol_github_model['rules'] >
	>
	type $mol_view__sub_bog_formigo_ai_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_attach__items_bog_formigo_ai_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['doc_items'] >
		,
		ReturnType< $mol_attach['items'] >
	>
	type $mol_button_major__title_bog_formigo_ai_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_formigo_ai_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['extract'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_status__status_bog_formigo_ai_8 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['communication'] >
		,
		ReturnType< $mol_status['status'] >
	>
	type $mol_list__rows_bog_formigo_ai_9 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['result_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_labeler__title_bog_formigo_ai_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['result_key'] >
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_bog_formigo_ai_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['Result_value'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_button_major__title_bog_formigo_ai_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_formigo_ai_13 = $mol_type_enforce<
		ReturnType< $bog_formigo_ai['apply_all'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	export class $bog_formigo_ai extends $mol_list {
		rules( ): string
		content( ): readonly(any)[]
		doc_items( next?: readonly(string)[] ): readonly(string)[]
		extract( next?: any ): any
		communication( ): any
		result_rows( ): readonly(any)[]
		result_key( id: any): string
		result_val( id: any): string
		Result_value( id: any): $mol_view
		apply_all( next?: any ): any
		Model( next?: $mol_github_model ): $mol_github_model
		extracted( next?: Record<string, any> ): Record<string, any>
		rows( ): ReturnType< $bog_formigo_ai['content'] >
		Title( ): $mol_view
		Docs( ): $mol_attach
		Extract( ): $mol_button_major
		Status( ): $mol_status
		Results( ): $mol_list
		Result_row( id: any): $mol_labeler
...
declare namespace $.$$ {
    class $bog_formigo_ai extends $.$bog_formigo_ai {
        content(): any[];
        result_rows(): $mol_labeler[];
        extracted_entries(): [string, string][];
        result_key(index: number): string;
        result_val(index: number): string;
        extract(): void;
        apply_all(): void;
    }
}
...
declare namespace $ {
	...
	type $bog_formigo_dashboard__workspace_bog_formigo_app_1 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['workspace'] >
		,
		ReturnType< $bog_formigo_dashboard['workspace'] >
	>
	type $bog_formigo_dashboard__template_select_bog_formigo_app_2 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['template_select'] >
		,
		ReturnType< $bog_formigo_dashboard['template_select'] >
	>
	type $bog_formigo_builder__template_bog_formigo_app_3 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['template'] >
		,
		ReturnType< $bog_formigo_builder['template'] >
	>
	type $bog_formigo_filler__template_bog_formigo_app_4 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['template'] >
		,
		ReturnType< $bog_formigo_filler['template'] >
	>
	type $bog_formigo_filler__submission_bog_formigo_app_5 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['submission'] >
		,
		ReturnType< $bog_formigo_filler['submission'] >
	>
	type $bog_formigo_filler__ai_suggestions_bog_formigo_app_6 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['ai_extracted'] >
		,
		ReturnType< $bog_formigo_filler['ai_suggestions'] >
	>
	type $bog_formigo_submissions__template_bog_formigo_app_7 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['template'] >
		,
		ReturnType< $bog_formigo_submissions['template'] >
	>
	type $bog_formigo_submissions_detail__submission_bog_formigo_app_8 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['detail_submission'] >
		,
		ReturnType< $bog_formigo_submissions_detail['submission'] >
	>
	type $bog_formigo_submissions_detail__workspace_bog_formigo_app_9 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['workspace'] >
		,
		ReturnType< $bog_formigo_submissions_detail['workspace'] >
	>
	type $bog_formigo_settings__workspace_bog_formigo_app_10 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['workspace'] >
		,
		ReturnType< $bog_formigo_settings['workspace'] >
	>
	type $bog_formigo_ai__extracted_bog_formigo_app_11 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['ai_extracted'] >
		,
		ReturnType< $bog_formigo_ai['extracted'] >
	>
	type $bog_formigo_ai__apply_all_bog_formigo_app_12 = $mol_type_enforce<
		ReturnType< $bog_formigo_app['ai_apply_all'] >
		,
		ReturnType< $bog_formigo_ai['apply_all'] >
	>
	export class $bog_formigo_app extends $mol_book2 {
		Theme( ): $mol_theme_auto
		spread( ): readonly(any)[]
		workspace( ): $bog_formigo_workspace
		template( id: any): $bog_formigo_template
		submission( id: any): $bog_formigo_submission
		ai_extracted( next?: Record<string, any> ): Record<string, any>
		detail_submission( id: any): $bog_formigo_submission
		ai_apply_all( next?: any ): any
		plugins( ): readonly(any)[]
		Placeholder( ): $mol_view
		pages( ): ReturnType< $bog_formigo_app['spread'] >
		template_select( id: any): any
		menu_page( ): $bog_formigo_dashboard
		builder_page( id: any): $bog_formigo_builder
		filler_page( id: any): $bog_formigo_filler
		submissions_page( id: any): $bog_formigo_submissions
		detail_page( id: any): $bog_formigo_submissions_detail
...
//# sourceMappingURL=formigo.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_formigo_app extends $.$bog_formigo_app {
        workspace(): $bog_formigo_workspace;
        spread(): ($.$bog_formigo_dashboard | $.$bog_formigo_builder)[] | ($.$bog_formigo_filler | $.$bog_formigo_ai)[] | ($.$bog_formigo_dashboard | $.$bog_formigo_submissions)[] | ($.$bog_formigo_dashboard | $.$bog_formigo_submissions_detail)[] | ($.$bog_formigo_dashboard | $.$bog_formigo_settings)[];
        template_select(id: string): void;
        template(id: string): $bog_formigo_template;
        submission(id: string): $bog_formigo_submission;
        detail_submission(id: string): $bog_formigo_submission;
        ai_apply_all(): void;
    }
}
